...
module.exports = async callback => {
  ...
  if (swapContractInfo[0]) {
    ...
    console.log("Ends at               : ", swapContractInfo[3].toString());
    console.log("ETH giver Eth address : ", swapContractInfo[4].toString());
    console.log("ETH giver Btc address : ", swapContractInfo[5].toString());
