...
module.exports = async callback => {
  ...
  if (swapContractInfo[0]) {
    ...
    console.log("BTC giver Eth address       : ", swapContractInfo[6].toString());
    console.log("Fullfill transaction hash   : ", swapContractInfo[7].toString());
    console.log("Transaction nbConfirmations : ", web3.utils.hexToAscii(swapContractInfo[8]));
    console.log("Transaction vout address    : ", web3.utils.hexToAscii(swapContractInfo[9]));
    console.log("Transaction vout value      : ", web3.utils.hexToAscii(swapContractInfo[10]));
    console.log("Exists                      : ", swapContractInfo[7] ? "Yes" : "No");
  } else {
